...
export default function Home() {
  ...
  return <main ref={ref}>
    <nav className="nav"><a href="#top" className="wordmark"><span className="wordmark-dot" />FIELD DAY LABS</a><div className="nav-right"><span>NYC / WORLDWIDE</span><a className="nav-link" href="#work">See the work <span>↘</span></a></div></nav>
